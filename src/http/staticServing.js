...
export function createStaticHandlers({ publicDir, storageSourceDir, aiSourceDir, sharedSourceDir }) {
  ...
  return {
    isPublicAsset(pathname) {
      ...
      return [ROUTES.favicon, ROUTES.appleTouchIcon, ROUTES.socialImage, ROUTES.manifest, ROUTES.serviceWorker, ROUTES.robots, ROUTES.llms, ROUTES.sitemap, ROUTES.status, ROUTES.verlauf, ROUTES.verlaufMesswerte, ROUTES.hilfe, ROUTES.entwickler, ROUTES.mausReplay, ROUTES.indexHtml, ROUTES.willkommen, ROUTES.programmieren, ROUTES.agb, ROUTES.widerruf, ROUTES.impressum, ROUTES.datenschutz, ROUTES.legalNoticeEn, ROUTES.privacyEn, ROUTES.supportEn, ROUTES.frameGuard].includes(pathname);
    },
