...
export function createStaticHandlers({ publicDir, storageSourceDir, aiSourceDir, sharedSourceDir }) {
  ...
  return {
    isPublicAsset(pathname) {
      ...
      return [ROUTES.favicon, ROUTES.appleTouchIcon, ROUTES.socialImage, ROUTES.manifest, ROUTES.serviceWorker, ROUTES.robots, ROUTES.llms, ROUTES.sitemap, ROUTES.status, ROUTES.impressum, ROUTES.datenschutz, ROUTES.legalNoticeEn, ROUTES.privacyEn].includes(pathname);
    },
