#!/bin/zsh
# smejj.com — smejj 1.5 messen
#
# Misst das Basismodell OHNE Adapter und smejj 1.5 MIT Adapter in EINEM Lauf
...
#
# WAS ZUR DEBATTE STEHT: smejj 1.4 kam auf 66,0 % gegen Basis 68,4 % — 2,4
# Punkte darunter. 1.5 hat 24 zusaetzliche handgeschriebene Paare fuer genau
# die Gebiete, in denen 1.4 verloren hat. Alles andere ist unveraendert.
#
# Reihe bisher:  1.2 = 51,0  |  1.3 = 62,8  |  1.4 = 66,0  |  Basis = 68,4
#
...
echo ""
echo "SCHRITT 2 — Messung starten (Basis nackt gegen smejj 1.5 mit Adapter)"
echo "────────────────────────────────────────────────────────────────────────"
SMEJJ_KANDIDAT=smejj-1-5 node scripts/training/smejj-1-1-messen.mjs --starten
MESS=$?
...
if [ $MESS -eq 0 ]; then
  ...
  echo "   SMEJJ_KANDIDAT=smejj-1-5 node scripts/training/smejj-1-1-messen.mjs --bewerten <Job-Kennung>"
else
