...
echo "────────────────────────────────────────────────────────────────────────"
SMEJJ_KANDIDAT=smejj-1-10 node scripts/training/smejj-1-1-messen.mjs --starten
MESS=$?
...
if [ $MESS -eq 0 ]; then
  ...
  echo "   SMEJJ_KANDIDAT=smejj-1-10 node scripts/training/smejj-1-1-messen.mjs --bewerten <Job-Kennung>"
else
