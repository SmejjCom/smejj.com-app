...
const transferStatus = [
  "Kimi K2.7 Code transfer preparation status",
  "",
...
const uploads = [
  {
    key: `${prefix}/notes/LICENSE`,
    body: await fetchText(`${hfBase}/raw/main/LICENSE`),
    contentType: "text/plain; charset=utf-8",
  },
  {
    key: `${prefix}/notes/THIRD_PARTY_NOTICES.md`,
    body: await fetchText(`${hfBase}/raw/main/THIRD_PARTY_NOTICES.md`),
    contentType: "text/markdown; charset=utf-8",
  },
  {
    key: `${prefix}/notes/README.md`,
    body: await fetchText(`${hfBase}/raw/main/README.md`),
    contentType: "text/markdown; charset=utf-8",
  },
  {
...
console.log("Kimi source metadata archive complete.");
