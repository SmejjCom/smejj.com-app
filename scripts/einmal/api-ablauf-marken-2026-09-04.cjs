#!/usr/bin/env node
// smejj.com — Marken-Heber fuer die Betreiber-Kaskade "Ablauf-Strich" (2026-09-04).
//
// Der Zweig aendert settings-surface.js (laedt api-center-surface.js?v=14).
...
if (!settings.includes("./api-center-surface.js?v=14")) {
  console.error("ABBRUCH: public/settings-surface.js laedt nicht api-center-surface.js?v=14 — Zweig nicht gemergt?");
  process.exit(1);
}
