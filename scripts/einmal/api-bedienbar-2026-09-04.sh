...
#
# Was schon passiert ist (ohne Klick): Commit b242e52f im Worktree
...
# Live-Beweis.
#
# Rollback: git revert b242e52f im Bauzweig + neuer Stempel; im Klon git revert des
# Deploy-Commits.
set -uo pipefail
...
git merge-base --is-ancestor b242e52f HEAD || abbruch "Commit b242e52f (bedienbare Ausgabe) liegt nicht auf HEAD" 3
