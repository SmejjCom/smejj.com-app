#!/usr/bin/env node
// smejj.com — Marken-Heber fuer die Betreiber-Kaskade "Zwei Reiter" (2026-09-04).
//
// Der Zweig aendert settings-surface.js (laedt api-center-surface.js?v=12).
...
if (!settings.includes("./api-center-surface.js?v=12")) {
  console.error("ABBRUCH: public/settings-surface.js laedt nicht api-center-surface.js?v=12 — Zweig nicht gemergt?");
  process.exit(1);
}
