...
# Beide Zweige gruen (64/64). Arbeitszweig: 6a5d093b. Bauzweig-Commit: 8c829dea (Reparatur + Aktionsliste, baut auf der Nachfrage auf)
...
# ist KEIN Fast-Forward und damit gesperrt; stattdessen `git revert 3ff9ab71` auf
