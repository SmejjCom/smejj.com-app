...
git add public/index.html public/sw.js public/manifest.webmanifest public/assets/index.html public/assets/sw.js docs/frontend/start-lock-manifest.json
...
(
  cd "$WT"
  git checkout "$QUELLE" -- public/index.html public/sw.js public/manifest.webmanifest public/assets/index.html public/assets/sw.js docs/frontend/start-lock-manifest.json
