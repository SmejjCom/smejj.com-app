...
<html lang="${locale.code}" dir="${locale.dir}" class="p-sprachstart">
  <head>
    ...
    <!-- Schutz wie auf der Startseite (Befund 2026-08-04): Diese Seiten
         entstanden ohne CSP und ohne Referrer-Regel, waehrend public/index.html
...
${faq}
    ...
    <script src="/assets/voice-landing.js?v=emojifrei-20260825x-4" type="module"></script>
  </body>
</html>
`;
}
