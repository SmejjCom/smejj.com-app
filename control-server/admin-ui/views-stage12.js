...
(function () {
  ...
  const REGELN = [
    ...
    { nr: 4, titel: "Live-Stand gegen Bau-Stand, immer nebeneinander",
      ...
      heute: "Die Seite »Was ist wirklich live?« stellt je Dienst den Live-Stand (vom Dienst gemeldet) neben den Bau-Stand (aus dem Repo) — der Control-Server kennt seinen Commit aus ZEABUR_GIT_COMMIT_SHA; setzt Zeabur ihn nicht (seit 15.09.2026), leitet die Bau-Wache (Nr. 76) ihn aus dem erfolgreichen Check-Run am Prozessstart ab und sagt das dazu.",
    ...
    { nr: 5, titel: "Artefakt ersetzt nie die Quelle",
      ...
      heute: "Die Konsole wird nur aus dem Bau-Branch-HEAD gespiegelt (sync_admin_console_pages.mjs --pruefen meldet jede Abweichung). Die Brücke steht mit Bündel-Version gegen Repo-Version auf der Auslieferungsseite. Die Schutz-Echtheit (Nr. 82) vergleicht alle 30 Minuten die ausgelieferten Dateien per Prüfsumme mit ihren Freigabe-Manifesten. Ein Screenshot-Vergleich fehlt noch — das steht dort auch.",
      seite: "/admin/auslieferung/", link: "Auslieferung" },
