...
import { pruefeAntwortQualitaet } from "../autopilots/antwortTuevAutopilot.js";
 ...
 */
export function registriereMedientyp(art, pruefer, { name } = {}) {
 ...
 */
export function bewerteErgebnis(art, ergebnis, kontext = {}) {
 ...
 */
export const QUALITAETS_PROBEN = Object.freeze([
...
export function fuehreQualitaetSelbsttestAus() {
  const fehler = [];
