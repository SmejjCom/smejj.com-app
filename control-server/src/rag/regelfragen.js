...
import { BEFEHLSFORM } from "./infrastrukturFrage.js";
 ...
 */
export const REGELKLASSEN = Object.freeze([
  {
    id: "schutz",
 ...
 */
export function erkenneRegelfrage(task) {
 ...
 */
export function erweitereRegelfrage(task) {
