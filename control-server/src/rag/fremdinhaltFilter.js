...
export function istFremdquelle(source = "") {
 ...
 */
export function entwaffneFremdtext(text = "") {
 ...
 */
export function formatFremdKontextBlock(treffer = []) {
 ...
 */
export function teileNachHerkunft(treffer = []) {
  const eigen = [];
  const fremd = [];
