...
// Teil 5 (Nr. 66-70, Betreiber-Freigabe 2026-08-30 "alle Rechte von A bis z"):
import { DECKUNG_AUTOPILOTEN } from "./opsAutopilotenListeDeckung.js";
...
const BASIS_AUTOPILOTEN = Object.freeze([
  {
    ...
    name: "Taktgeber",
    nummer: "32",
    kurz: "Der Motor, der über 60 Läufe im Control-Server alle 30 Minuten antreibt — und sich dabei selbst bezeugt.",
    funktionen: [
    ...
    verbessert: "Ein stiller Stillstand des Taktgebers wird sichtbar, statt sich als Dutzende unerklärliche Ausfälle zu tarnen",
  ...
  },
  {
    ...
    verbessert: "EHRLICH (Runde 03.09.): die Ampel prüft nur den Rechercheplaner per Selbsttest — ob echte Recherchen besser werden, misst allein die Evolution-Engine (Art recherche)",
    neuigkeiten: ["Deep Research Engine aktiv", "Vollwertige Quellensynthese einsatzbereit"],
    ort: "Control Server (Autopilot-Läufer, nur Selbsttest)",
    zeitplan: "alle 30 Minuten (Selbsttest der Bausteine — kein Betriebsdatenbezug)",
    messung: "heartbeat",
    erwartetAlleMs: STUNDE_MS,
    schonfristMs: STUNDE_MS,
  ...
  },
  {
    ...
    verbessert: "EHRLICH (03.09.): die Ampel rechnet alle 30 Minuten eine Probe-Summe im Läufer — kein Nutzer-Code läuft durch diese Sandbox",
  ...
  },
  {
    ...
    verbessert: "EHRLICH (03.09.): die Ampel prüft nur die Fakten-Extraktion an einer Probe — die Ablage user-memory wird von diesem Lauf nicht berührt",
  ...
  },
  {
    ...
    verbessert: "EHRLICH (03.09.): die Ampel prüft die Reparatur-Erkennung an drei kaputten und einer gesunden Probe — keine Zahl über echte Antworten",
    neuigkeiten: ["Self-Healing Engine im LLM-Loop aktiv", "0 abgebrochene JSON-Streams"],
    ort: "Control Server (Autopilot-Läufer, echte Daten seit 15.09.)",
    zeitplan: "alle 30 Minuten (Selbsttest der Bausteine — kein Betriebsdatenbezug)",
    messung: "heartbeat",
    erwartetAlleMs: STUNDE_MS,
    schonfristMs: STUNDE_MS,
  ...
  },
  {
    ...
    verbessert: "EHRLICH (03.09.): die Ampel fragt nur die Health-Endpunkte von Video-Worker und Bild-Maler ab — ob ein Bild oder Video wirklich entsteht, misst sie nicht",
    neuigkeiten: ["Multimodale Inferenz-Engine bereit", "Audio/Vision Chunks validiert"],
    ort: "Control Server (Autopilot-Läufer, Health-Sonde)",
    zeitplan: "alle 30 Minuten (GET /health von Video-Worker und Bild-Maler)",
    messung: "heartbeat",
    erwartetAlleMs: STUNDE_MS,
    schonfristMs: STUNDE_MS,
  ...
  },
  {
    ...
    verbessert: "EHRLICH (03.09.): die Ampel prüft den Aufgaben-Graphen an einer Probe — kein Tempo-Gewinn wird gemessen",
  ...
  },
  {
    ...
    verbessert: "EHRLICH (03.09.): die Ampel prüft die Qualitätsbewertung an gut/schlecht-Proben — Training ruht seit 06.08. (Charta §0), die DPO-Ablage füllt Nr. 05/65",
  ...
  },
  {
    ...
    verbessert: "EHRLICH (03.09.): die Ampel prüft zwei Probe-Prompts — die echte Modellwahl trifft der Router der Brücke, gemessen von Nr. 62/71",
  ...
  },
  {
    ...
    verbessert: "EHRLICH (03.09.): die Ampel prüft die Schatten-Bewertung an einer Probe — es gibt kein eigenes Modell als Datei und keinen Canary (Audit 03.09., Vorschlag Nr. 79)",
  ...
  },
  {
    ...
    verbessert: "EHRLICH (03.09.): die Ampel prüft die Denkketten-Bewertung an einer Probe — im Chatbetrieb bricht dieser Prüfer nichts ab",
  ...
  },
  {
    ...
    verbessert: "EHRLICH (03.09.): die Ampel prüft die Destillat-Funktion an einer Probe — Fremdmodell-Ausgaben sind laut Rechteprüfung vom 17.07. kein Trainingsmaterial",
  ...
  },
  {
    ...
    verbessert: "EHRLICH (03.09.): die Ampel prüft nur, dass der Mutations-Baustein eine Ausgabe liefert — der schwächste Selbsttest der Liste, Ausbau offen",
  ...
  },
  {
    ...
    verbessert: "EHRLICH (03.09.): die Ampel prüft die ELO-Mathematik — echte Duelle gegen GPT, Gemini oder Claude finden hier nicht statt (Vergleich: Nr. 04 Radar, Nr. 38)",
  ...
  },
  {
    ...
    verbessert: "EHRLICH (03.09.): die Ampel prüft den Vorschau-Baustein an einer Probe — Nutzer-Vorschauen laufen im Browser und werden hier nicht gezählt",
  ...
  },
  {
    ...
    verbessert: "EHRLICH (03.09.): die Ampel prüft Sitzung und Rahmen an einer Probe — die 300 ms wurden nie gemessen; die echte Sprachkette misst Nr. 03",
  ...
  },
  {
    ...
    verbessert: "EHRLICH (03.09.): die Ampel prüft die Patch-Erkennung an einer kaputten Probe — keine Pull Requests werden von hier bearbeitet",
 ...
 * Teillisten.
 */
export const AUTOPILOTEN = Object.freeze([...BASIS_AUTOPILOTEN, ...BETRIEB_AUTOPILOTEN, ...EVOLUTION_AUTOPILOTEN, ...SCHUTZ_AUTOPILOTEN, ...WACHSTUM_AUTOPILOTEN, ...DECKUNG_AUTOPILOTEN]);
