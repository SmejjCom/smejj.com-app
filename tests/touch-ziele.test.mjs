...
test("Runde 5: Kopfknoepfe, Werkzeugzeilen, Konto-Reiter und Plus-Menue auf grobem Zeigegeraet 44 px", () => {
  ...
  assert.match(k, /#start \.prompt-glass #startMessage,body #code \.codefeld #codeAufgabe\{min-height:44px!important\}/, "gegen die wichtige Buendel-Regel min-height:40px");
