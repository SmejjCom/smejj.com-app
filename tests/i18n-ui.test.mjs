...
const composerTools = fs.readFileSync(path.join(publicDir, "composer-tools.js"), "utf8")
  ...
  + fs.readFileSync(path.join(publicDir, "ai", "bild-nachholen.js"), "utf8") // Hinweis Bild-Rettung (24.09.2026)
  + fs.readFileSync(path.join(publicDir, "code-modell-menue.js"), "utf8"); // Begruessung Code-Bereich (24.09.2026)
