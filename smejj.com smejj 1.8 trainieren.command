#!/bin/zsh
# smejj.com — smejj 1.8 trainieren
#
# WAS NEU IST: das VERHAELTNIS. Zum ersten Mal.
#
#                        bisher (1.7)      jetzt (1.8)
#   handgeschrieben      83   (1,8 %)      498  (44 %)
#   Rechenaufgaben       4454 (98,2 %)     631  (56 %)
#
# Dieselben 83 Paare, sechsfach gewichtet; die Rechenaufgaben von 9.000 roh
# auf 900 gesenkt.
#
# WARUM: Vier Versuche lang habe ich am INHALT der Paare gedreht, und jedes Mal
# stieg ein Gebiet und zwei fielen:
#
#   1.5  mehr "Ja"-Paare   -> Ehrlichkeit 65 -> 45
#   1.6  weniger "Ja"      -> Schutz-Locks 75 -> 60
#   1.7  Kontrastpaare     -> Locks 60 -> 70, dafuer Wissen 40 -> 26,7
#
# Acht neue Paare bei 83 verschieben das Gleichgewicht des ganzen Modells,
# wenn diese 83 nur 1,8 Prozent der Trainingszeit ausmachen. Das Modell hat
# fast ausschliesslich Rechnen geuebt.
#
# DABEI AUFGEFALLEN, und es betrifft alle bisherigen Laeufe: Die Profile im
# Datensatzbau sahen aus, als steuerten sie Menge und Startwert — der Code las
# die festen Konstanten. 1.5, 1.6 und 1.7 hatten deshalb trotz verschiedener
# Startwerte DIESELBEN Rechenaufgaben. Behoben.
#
# Wiederholung erhoeht das Gewicht, nicht den Inhalt: aus 83 Paaren werden
# keine 500 verschiedenen. Sie ersetzt kein einziges neu geschriebenes Paar.
#
# Reihe: 1.4 = 66,0 | 1.5 = 62,6 | 1.6 = 64,9 | 1.7 = 63,3 | Basis = 68,0
#
# Datensatz: datasets/smejj-1-8 (1.129 Paare — ein Viertel der bisherigen).
# Das Training ist dadurch deutlich kuerzer: rund 140 statt 567 Schritte.
...
echo "────────────────────────────────────────────────────────────────────────"
SMEJJ_KANDIDAT=smejj-1-8 SMEJJ_DATENSATZ=smejj-1-8 node scripts/training/smejj-1-1-trainieren.mjs --starten
START=$?
...
if [ $START -eq 0 ]; then
  ...
  echo ""
  echo "Fortschritt:  SMEJJ_KANDIDAT=smejj-1-8 node scripts/training/smejj-1-1-trainieren.mjs --stand"
  echo ""
  echo "Danach messen mit der Datei 'smejj.com smejj 1.8 messen.command'."
else
