...
import { baueFernwege } from "./browser-pane-fernwege.js?v=browser-pane-20260918-11";
import {
  buildExternalFallbackHtml,
  buildLiveBrowserHtml,
  buildRemoteBrowserHtml
} from "./browser-pane-render.js?v=browser-pane-20260906-10";
export { buildExternalFallbackHtml, buildRemoteBrowserHtml, isRemoteScreenshot } from "./browser-pane-render.js?v=browser-pane-20260906-10";
...
import { zeichneTableiste } from "./browser-pane-tableiste.js?v=browser-pane-20260918-4";
...
let suche = null;
import { buildErrorPageHtml, buildPaneShellHtml } from "./browser-pane-render.js?v=browser-pane-20260906-10";
