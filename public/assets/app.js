...
import { bindeSuchNachlader, holeSuche } from "./such-nachladen.js?v=3";
...
const holeFlaechen = ladeBeiAnsicht(["start", "chat"], () => import("./premium-surfaces.js?v=b47m").then((m) => (m.enhancePremiumSurfaces(), m)));
...
function bindStartComposer() {
  ...
  ladeBeiKlick(["[data-start-tool]", "#composerPlusButton"], () => import("./composer-tools.js?v=werkzeuge-13").then((m) => m.initComposerTools()));
