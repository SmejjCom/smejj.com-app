...
import { activeChatId, newChat } from "/assets/chat-store.js?v=b83";
...
export function fuehreAus(act, eintrag) {
  ...
  if (medium) return import("/assets/chat-medien-ansicht.js?v=3").then((m) => m.oeffneTeilenBlatt(medium, { text })).catch(() => teilen(text));
