...
import { activeChatId, newChat } from "/assets/chat-store.js?v=g20260925222859";
...
export function fuehreAus(act, eintrag) {
  ...
  if (medium) return import("/assets/chat-medien-ansicht.js?v=8").then((m) => m.oeffneTeilenBlatt(medium, { text })).catch(() => teilen(text));
