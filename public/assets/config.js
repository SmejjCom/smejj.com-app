...
const API_PATHS = {
  ...
  // jeher, der Sprachwelle fehlte er: faellt die Bridge aus, schaltete sich das
  // Ohr bei der ersten 404 fuer die ganze Sitzung ab und uebrig blieb die
  ...
  // Sprachworker. Die Bridge hat einen (premiumVoice: true), der Control Server
  // nicht. Eine Adresse, die zuverlaessig 503 antwortet, waere schlechter als
  // keine — der Browser hielte es fuer einen voruebergehenden Ausfall und
  // versuchte es bei jedem Satz erneut.
