...
import { bindeSuchNachlader, holeSuche, ladeSucheFuerAnsicht } from "./such-nachladen.js?v=24";
import { initWorkspaceBridge } from "./workspace-bridge.js";
import { ladeBeiAnsicht, ladeBeiKlick } from "./nachladen.js?v=2";
import { holeSendepfad } from "./sendepfad-nachladen.js?v=35";
...
const holeFlaechen = ladeBeiAnsicht(["start", "chat"], () => import("./premium-surfaces.js?v=b47v-6").then((m) => (m.enhancePremiumSurfaces(), m)));
...
function bindStartComposer() {
  ...
  window.smejjLadeComposerTools = ladeBeiKlick(["[data-start-tool]", "#composerPlusButton"], () => import("./composer-tools.js?v=werkzeuge-30").then((m) => m.initComposerTools()));
