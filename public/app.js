...
import { Icons, closeModal, openModal, renderChatMarkdown, renderEmptyState, setButtonIcon, showToast } from "./components.js?v=g20260926153740";
...
function bindStartComposer() {
  ...
  window.smejjLadeComposerTools = ladeBeiKlick(["[data-start-tool]", "#composerPlusButton"], () => import("./composer-tools.js?v=g20260926153741").then((m) => m.initComposerTools()));
