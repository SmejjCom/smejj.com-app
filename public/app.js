...
import { Icons, closeModal, openModal, renderChatMarkdown, renderEmptyState, setButtonIcon, showToast } from "./components.js?v=g20260926161338";
import { bindPasteAttach, composePastedTask } from "./composer-paste-attach.js?v=8";
import { bindeSuchNachlader, holeSuche, ladeSucheFuerAnsicht } from "./such-nachladen.js?v=35";
...
import { bindUploads, validateBrowserUpload } from "./uploads-surface.js?v=b39u-3";
...
const MODEL_MODES = Object.freeze({
  ...
  "smejj 1.0": AI_MODES.disabled, "smejj 1.1": AI_MODES.disabled, "smejj 1.2": AI_MODES.disabled, "smejj 1.3": AI_MODES.disabled, "smejj 1": AI_MODES.disabled, "Auto": AI_MODES.disabled, // 07.09.: Name reist als body.model; 1.2/1.3 tiefe Spur, "Auto" = Server-Router waehlt + Ersatzkette; 13.09.: "smejj 1" = eigenes Modell (Hausmodell), ohne Eintrag hier fiele die Wahl still auf "smejj 1.0" zurueck
...
function bindStartComposer() {
  ...
  window.smejjLadeComposerTools = ladeBeiKlick(["[data-start-tool]", "#composerPlusButton"], () => import("./composer-tools.js?v=g20260926161338").then((m) => m.initComposerTools()));
