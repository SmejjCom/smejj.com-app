...
import { activeChatId, newChat } from "/assets/chat-store.js?v=g20260926153735";
...
export function fuehreAus(act, eintrag) {
  ...
  if (medium) return import("/assets/chat-medien-ansicht.js?v=10").then((m) => m.oeffneTeilenBlatt(medium, { text })).catch(() => teilen(text));
