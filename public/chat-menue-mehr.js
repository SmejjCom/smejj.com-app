...
import { activeChatId, newChat } from "/assets/chat-store.js?v=g20260926145006";
...
export function fuehreAus(act, eintrag) {
  ...
  if (medium) return import("/assets/chat-medien-ansicht.js?v=9").then((m) => m.oeffneTeilenBlatt(medium, { text })).catch(() => teilen(text));
