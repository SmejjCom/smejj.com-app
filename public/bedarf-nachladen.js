...
if (location.pathname.includes("papierkorb")) {
  import("./papierkorb.js?v=30");
} else {
  ladeBeiKlick(['[data-view="papierkorb"]', '[data-jump="papierkorb"]'], () => import("./papierkorb.js?v=30"));
}
...
//    Liste SOFORT aufgeht, nicht erst beim naechsten Zeichen.
{
  ...
  if (feld) {
    const wecker = () => {
      ...
      import("./erwaehnung.js?v=20").then(() => feld.dispatchEvent(new Event("input", { bubbles: true })))
...
{
  const laden = () => import("./chat-history-view.js?v=b75");
...
if (location.pathname.includes("arbeitsbereiche") || location.pathname.includes("projects")) {
  import("./arbeitsbereiche.js?v=37");
} else {
  ladeBeiKlick(['[data-view="arbeitsbereiche"]', '[data-jump="arbeitsbereiche"]'], () => import("./arbeitsbereiche.js?v=37"));
}
