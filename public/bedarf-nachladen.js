...
if (location.pathname.includes("papierkorb")) {
  import("./papierkorb.js?v=27");
} else {
  ladeBeiKlick(['[data-view="papierkorb"]', '[data-jump="papierkorb"]'], () => import("./papierkorb.js?v=27"));
}
...
//    Liste SOFORT aufgeht, nicht erst beim naechsten Zeichen.
{
  ...
  if (feld) {
    const wecker = () => {
      ...
      import("./erwaehnung.js?v=17").then(() => feld.dispatchEvent(new Event("input", { bubbles: true })))
...
{
  const laden = () => import("./chat-history-view.js?v=b72");
...
if (location.pathname.includes("arbeitsbereiche") || location.pathname.includes("projects")) {
  import("./arbeitsbereiche.js?v=34");
} else {
  ladeBeiKlick(['[data-view="arbeitsbereiche"]', '[data-jump="arbeitsbereiche"]'], () => import("./arbeitsbereiche.js?v=34"));
}
