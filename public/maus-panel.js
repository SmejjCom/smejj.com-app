...
import { openPane, activeTab, addTab, setFrame, commitHistory, persistTabs, render, refs, state } from "./browser-pane.js?v=browser-pane-20260918-11";
...
export async function zeigeBrueckenZustand() {
  ...
  try {
    ...
    const deutung = await import("./maus-absicht.js?v=53");
